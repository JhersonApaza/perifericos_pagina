/**
 * features/ventas/ventas.controller.js
 * Controlador del módulo de ventas.
 * Migrado desde controllers/VentaController.js — lógica 100% preservada.
 */
...
class VentaController {
  ...
  async index(req, res) {
    ...
    try {
      ...
      res.render('ventas/pages/index', { productos, ventas, stats, es_admin, toast_ok, toast_warn });
    } catch (err) {
